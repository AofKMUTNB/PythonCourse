...
btnmin = Button(fg="black",bg="orange",font=('arial',30,'bold'),text="-",command = lambda:btn("-"),padx=35,pady=15).grid(row=2,column=3)
...
btndot = Button(fg="black",bg="orange",font=('arial',30,'bold'),text=".",command=lambda:btn("."),padx=36,pady=15).grid(row=4, column=0)
btn0 = Button(fg="black",font=('arial',30,'bold'),text="0",command=lambda:btn(0),padx=30,pady=15).grid(row=4, column=1)
btnbs = Button(fg="black",font=('arial',30,'bold'),text="/",command=lambda:btn("/"),padx=36,pady=15).grid(row=4, column=2)
btnx = Button(fg="black",bg="orange",font=('arial',30,'bold'),text="x",command = lambda:btn("*"),padx=30,pady=15).grid(row=4,column=3)
